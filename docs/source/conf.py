...
MOCK_MODULES = [
    ...
    'torch.optim.lr_scheduler', 'numpy', 'torch.nn.Module',
]
...
latex_documents = [
    (master_doc, 'GPyTorch.tex', 'GPyTorch Documentation',
     'Cornellius GP', 'manual'),
]
...
man_pages = [
    (master_doc, 'gpytorch', 'GPyTorch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GPyTorch', 'GPyTorch Documentation',
     author, 'GPyTorch', 'One line description of project.',
     'Miscellaneous'),
]
